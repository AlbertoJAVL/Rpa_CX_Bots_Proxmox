                    ...
                    if 'cancelado' in  estado_orden or 'completa'  in  estado_orden:
                        ...
                        if status == True:
                            ...
                            if status_nuevo_caso == 0:
                                ...
                                response = api.orden_cerrada(info[0]["id"],info[0]["lead_id"],info[0]["cuenta"],info[0]["compania"],info[0]["numOrden"],info[0]["tipo"],info[0]["motivoOrden"],info[0]["fechaTecnico"],info[0]["comentarios"],info[0]["hub"],info[0]["rpt"],info[0]["region"],info[0]["quienResponde"],info[0]["transferir"],info[0]["nombreContacto"],info[0]["comentariosCyber"],info[0]["nodo"],info[0]["source"],info[0]["time_carga"],status,info[0]["fechaHoraCierre"],cn,info[0]["usuario_creo"],info[0]["user_registro"],info[0]["procesando"],info[0]["fechaCompletado"],info[0]["fechaCreado"],info[0]["cve_usuario"],ip) 
