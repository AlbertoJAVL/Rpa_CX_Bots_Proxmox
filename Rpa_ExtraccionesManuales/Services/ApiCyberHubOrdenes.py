...
url = 'https://rpabackizzi.azurewebsites.net/Reporte/getCuentaExtraccion'
urlOrden = 'https://rpabackizzi.azurewebsites.net/Reporte/ActualizaEjecucionExtraccion'
...
# datorR = datosSR.replace("'[", "")
# datorR = datorR.replace("]'", "")
# datos = json.loads(datorR)
...
def extraccion_cerrada(iD,tipoExtraccion, fechaExtraccion, parametrosExtraccion, archivo, cve_usuario, fechaInicial, fechaFinal, fechaCompletado, status, procesando, ip):
    datos = {
        "id":iD,
