...
url = 'https://rpabackizzi.azurewebsites.net/AjustesNotDone/getCuentaAjustesCasosNegocioCobranza'
urlOrden = 'https://rpabackizzi.azurewebsites.net/AjustesNotDone/ActualizaAjustesCasosNegocioCobranza'
...
def ajusteCerrado(id, casoNegocio, categoria, cuenta, estado, fechaApertura, mediosContacto, motivoCliente, motivos, solucion, submotivo, cve_usuario, fechaCompletado, fechaCaptura, status, procesando, ip, numAjuste, CNGenerado, statusCNGenerado, estatusAjuste, prioridad):
    datos = {
