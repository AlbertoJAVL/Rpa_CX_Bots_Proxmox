...
url = 'https://rpabackizzi.azurewebsites.net/AjustesNotDone/getCuentaOrdenTroubleCall'
urlOrden = 'https://rpabackizzi.azurewebsites.net/AjustesNotDone/ActualizaOrdenTroubleCall'
...
def ajusteCerrado(id, numeroOrden, fechaCaptura, fechaCompletado, status, cve_usuario, procesando, cuenta, tipo, motivo, comentarios, numeroCN):
    datos = {
