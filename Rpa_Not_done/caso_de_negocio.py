...
def pantalla_unica_consulta(driver, cuenta_api):
    ...
    try:
        ...
        print('Entró a la Pantall Unica')
...
def nuevo_caso_negocio(driver, medio_contacto, categoria, motivo, sub_motivo, solucion, motivo_cierre, comentarios, estado):
    ...
    try:
        ...
        if status_caso_repetido == True:
            print('EL caso de negocio esta repwtido')
        ...
        element_num_caso =  driver.find_element(By.XPATH, caso_negocio['numero_caso']['xpath'])
        ...
        #Comentarios
        element = driver.find_element(By.XPATH, caso_negocio['comentarios']['xpath'] )
